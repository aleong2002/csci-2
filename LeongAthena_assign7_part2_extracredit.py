...
#
# output:     returns the newly constructed string
def vowel_cycle(word, direction):
    newword = ""
    for c in word:
        if c.isupper():
            if c in ["A", "E", "I", "O", "U"]:
...
while True:
    ...
    if encoding == "END":
        ...
        reverse = ""
        for c in encoding:
            if c in ["A", "X", "F", "U", "D", "L", "R", "P", "Q", "S", "V", "W"]:
                if c == "A":
                    ...
                    phrase = add_padding(phrase, 1)
                    print("* Padding with 1 letter", phrase)
                    reverse += "Q"
                elif c == "Q":
                    phrase = remove_padding(phrase, 1)
                    print("* Removing padding of 1 letter:", phrase)
                    reverse += "P"
                elif c == "S":
                    phrase = swap_characters(phrase)
                    print("* Swapping characters:", phrase)
                    reverse += "S"
                elif c == "V":
                    phrase = vowel_cycle(phrase, "up")
                    print("* Cycling vowels up:", phrase)
                    reverse += "W"
                else:
                    phrase = vowel_cycle(phrase, "down")
                    print("* Cycling vowels down:", phrase)
                    reverse += "V"
            else:
        ...
        print("Reversal pattern:", reverse)
        print()
